...
public class FoodActivity extends AppCompatActivity implements NetworkResponseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TaskFoods taskFoods = new TaskFoods(FoodActivity.this);
        taskFoods.execute();
    ...
    private void eventClick() {
        ...
        mBtnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FoodActivity.this, CategoryFragment.class);
