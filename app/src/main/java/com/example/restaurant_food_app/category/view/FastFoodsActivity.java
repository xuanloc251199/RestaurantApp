...
import com.example.restaurant_food_app.api.TaskFastFoods;
...
public class FastFoodsActivity extends AppCompatActivity implements NetworkResponseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TaskFastFoods taskFastFoods = new TaskFastFoods(FastFoodsActivity.this);
        taskFastFoods.execute();
    ...
    private void eventClick() {
        ...
        mBtnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FastFoodsActivity.this, CategoryFragment.class);
