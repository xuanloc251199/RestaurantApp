...
public class NewPlacesApdapter extends RecyclerView.Adapter<NewPlacesApdapter.ViewHolder>{

    Context mContext;
    List<NewPlaces> mData;

    public NewPlacesApdapter(Context mContext, List<NewPlaces> mData) {
